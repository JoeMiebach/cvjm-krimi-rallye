...
export const api = {
  ...
  unlockStationForTeam: (stationId, teamId) => request('/admin/stations/unlock-for-team.php', { method: 'POST', body: { station_id: stationId, team_id: teamId } }),
  ...
  sendBroadcast: (rallyeId, messageText, targetTeamIds = null) => request('/admin/broadcast.php', { method: 'POST', body: { rallye_id: rallyeId, message_text: messageText, target_team_ids: targetTeamIds } }),
  ...
  resetGame: (rallyeId) => request('/admin/game/reset.php', { method: 'POST', body: { rallye_id: rallyeId, confirm: true } }),
  ...
  updateStoryNode: (id, payload) => request('/admin/story-nodes.php', { method: 'PUT', query: { id }, body: payload }),
  ...
  updateStoryNodeOption: (id, payload) => request('/admin/story-node-options.php', { method: 'PUT', query: { id }, body: payload }),
  ...
  getPhotoSubmissions: (rallyeId) => request('/admin/photo-submissions.php', { query: { rallye_id: rallyeId } }),
  awardPhotoPoints: (submissionId, points) => request('/admin/photo-submissions/award.php', { method: 'POST', body: { submission_id: submissionId, points } }),
  getBroadcastTemplates: (rallyeId) => request('/admin/broadcast-templates.php', { query: { rallye_id: rallyeId } }),
  createBroadcastTemplate: (payload) => request('/admin/broadcast-templates.php', { method: 'POST', body: payload }),
  updateBroadcastTemplate: (id, payload) => request('/admin/broadcast-templates.php', { method: 'PUT', query: { id }, body: payload }),
