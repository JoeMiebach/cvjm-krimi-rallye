...
// passende Eingabe direkt in der Bubble (Buttons / Text / Zahl / "Raetsel
// oeffnen"-Verweis / Foto-Upload). Siehe 05_Technische_Spezifikation_Ermittler_Chat_v1.md.
...
function ChatBubble({ entry, onRespond, onSubmitPhoto, navigate, highlight }) {
  ...
  // Scroll + Highlight wenn bubbleRef gesetzt wurde UND highlight=true
  useEffect(() => {
