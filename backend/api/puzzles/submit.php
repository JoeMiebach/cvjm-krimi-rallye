...
// GEAENDERT (13.09.2026, Option A): Legacy-Ermittlungsakte (team_story_clues)
// entfernt -- das Ermittler-Chat-System (story_nodes/team_story_log) ist ab
// sofort das alleinige Story-System. story_clue_text wird nicht mehr in
// team_story_clues gespeichert und nicht mehr im Response zurueckgegeben.
// Siehe docs/03_Datenbank.md, Abschnitt "team_story_clues (entfernt)".
...
// ---------------------------------------------------------------------
// Chat-Progression nach korrekter Puzzle-Antwort
// ---------------------------------------------------------------------
$nextNodeId = null;
if ($isCorrect) {
