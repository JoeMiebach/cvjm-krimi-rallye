...
5. **NEU:** Soll `POST /puzzles/submit.php` bei richtiger Antwort direkt den zugehoerigen
...
6. **NEU:** Die eigene Live-Positionsanzeige des Teams (`watchPosition`-basiert) muss noch auf
