-- Viking-Schatz Rallye: Multi-Rallye-Datenbankschema (Version 2.2)
-- Ersetzt: 03_Datenbank_Schema_MySQL_MultiRallye.sql (v2.1)
-- AENDERUNG v2.2: Cleanup-Query am Ende korrigiert (altersbasiert statt game_end_time-gekoppelt).
-- OFFENE FRAGE: ggf. ALTER TABLE puzzles ADD COLUMN story_clue_text TEXT NULL AFTER hint;
-- (erst gegen echten Code von clues.php/submit.php verifizieren, siehe API-Spec v3)
...
CREATE TABLE puzzles (
    ...
    question TEXT NOT NULL, hint TEXT, hint_penalty INT DEFAULT 5, media_url VARCHAR(255),
...
-- Lazy Cleanup (KORRIGIERT in v2.2): altersbasiert statt an game_end_time gekoppelt.
UPDATE teams
