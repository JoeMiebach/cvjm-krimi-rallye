...
-- TESTSZENARIO SCHNELLENBACH - VERSION 5.1 (11.09.2026, 11:57 Uhr)
--
-- AENDERUNG GEGENUEBER V5:
--   - Initiale team_story_log-Zustellung jetzt per INSERT ... SELECT
--     fuer ALLE existierenden Teams dieser Rallye (nicht nur 3
--     manuelle Test-Teams). Damit funktioniert das Skript auch mit
--     neu erstellten Start-Codes/Teams sofort ohne manuelle Nacharbeit.
--   - is_game_running = 1 fuer die Rallye gesetzt (wird von der App
--     oft zur Freigabe benoetigt).
--   - Seed-Codes fuer Test-Teams bleiben erhalten (SNB-TEST-01/02/03),
--     aber nicht mehr hart in team_story_log referenziert.
--
